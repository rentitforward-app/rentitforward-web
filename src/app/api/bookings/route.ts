  ...
  try {
    ...
    const { data: booking, error: bookingError } = await supabase
      ...
      .insert({
        ...
        insurance_fee: paymentBreakdown.insuranceFee,
        ...
        // Owner earnings tracking (based on PRICING_AND_INCENTIVES.md)
        owner_commission_rate: paymentBreakdown.ownerCommissionRate,
